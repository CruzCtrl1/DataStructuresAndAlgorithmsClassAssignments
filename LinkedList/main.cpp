...
void reverseTester()
{
   LinkedList<string>* listPtr2 = new LinkedList<string>();
   cout << "Testing the reverse function:" << endl;
   cout << "First making a list." << endl;
   string data[] = {"A", "B", "C", "D", "E"};
   for(int i = 0; i < 5; i++)
   {
      if(listPtr2->insert(i + 1, data[i]))
      {
   ...
   cout << "Using the reverse function:" << endl;
   listPtr2->reverse();
   displayList(listPtr2);
}
